...
namespace Services.API.Orders
{
    ...
    {
        static readonly string order1 = "{\"number\":\"2343356554\",\"serial_number\":\"288382\",\"status\":2,\"start_city\":\"Петропавловская Борщаговка\",\"start_address\":\"ул. Садовая, 1В\",\"delivery_city\":\"Петропавловская Борщаговка\",\"distance\":674,\"client_phone\":\"+380992373767\",\"comments\":\"Не трясти при перевозке.\",\"contents\":[{\"name\":\"Пицца\",\"count\":4,\"price\":80},{\"name\":\"Бургер 'DeLuxe\",\"count\":2,\"price\":120},{\"name\":\"Картошка 'По селянски'\",\"count\":4,\"price\":35}],\"amount\":83,\"type\":0}";
        //static readonly string order1 = "{\"number\":\"2343356554\",\"serial_number\":\"288382\",\"status\":5,\"start_city\":\"Петропавловская Борщаговка\",\"start_address\":\"ул. Садовая, 1В\",\"delivery_city\":\"Петропавловская Борщаговка\",\"distance\":5674,\"client_phone\":\"+380992373767\",\"comments\":\"Не трясти при перевозке. Заехать во двор через арку\",\"contents\":[{\"name\":\"Нагетсы\",\"count\":2,\"price\":50},{\"name\":\"Пицца\",\"count\":4,\"price\":80},{\"name\":\"Бургер 'DeLuxe\",\"count\":2,\"price\":120},{\"name\":\"Картошка 'По селянски'\",\"count\":4,\"price\":35}],\"amount\":835,\"type\":1,\"end_time\":" + DateTimeOffset.Now.Add(TimeSpan.FromMinutes(30)).ToUnixTimeSeconds() + ",\"client_liked\":true}";
        static readonly string order2 = "{\"number\":\"2343356555\",\"serial_number\":\"288383\",\"status\":4,\"start_city\":\"Петропавловская Борщаговка\",\"start_address\":\"ул. Садовая, 1В\",\"delivery_city\":\"Петропавловская Борщаговка\",\"delivery_address\":\"ул. Богдана Хмельницкого, 28\",\"distance\":5674,\"client_phone\":\"+380992373767\",\"comments\":\"Не трясти при перевозке. Заехать во двор через арку\",\"contents\":[{\"name\":\"Нагетсы\",\"count\":2,\"price\":50},{\"name\":\"Бургер 'DeLuxe\",\"count\":2,\"price\":120},{\"name\":\"Картошка 'По селянски'\",\"count\":4,\"price\":35}],\"amount\":835,\"type\":2,\"end_time\":" + DateTimeOffset.Now.Add(TimeSpan.FromMinutes(20)).ToUnixTimeSeconds() + ",}";
        static readonly string order3 = "{\"number\":\"2343356550\",\"serial_number\":\"288378\",\"status\":0,\"start_city\":\"Петропавловская Борщаговка\",\"start_address\":\"ул. Садовая, 1В\",\"delivery_city\":\"Петропавловская Борщаговка\",\"delivery_address\":\"ул. Богдана Хмельницкого, 28\",\"distance\":5674,\"client_phone\":\"+380992373767\",\"type\":0,\"end_time\":" + DateTimeOffset.Now.Add(TimeSpan.FromMinutes(40)).ToUnixTimeSeconds() + ",\"client_liked\":true}";
        static readonly string order4 = "{\"number\":\"2343356551\",\"serial_number\":\"288379\",\"status\":0,\"start_city\":\"Петропавловская Борщаговка\",\"start_address\":\"ул. Садовая, 1В\",\"delivery_city\":\"Петропавловская Борщаговка\",\"delivery_address\":\"ул. Богдана Хмельницкого, 28\",\"distance\":74,\"client_phone\":\"+380992373767\",\"comments\":\"Не трясти при перевозке. Заехать во двор через арку\",\"contents\":[{\"name\":\"Нагетсы\",\"count\":2,\"price\":50},{\"name\":\"Пицца\",\"count\":4,\"price\":80},{\"name\":\"Бургер 'DeLuxe\",\"count\":2,\"price\":120},{\"name\":\"Картошка 'По селянски'\",\"count\":4,\"price\":35}],\"amount\":835,\"type\":2,\"end_time\":" + DateTimeOffset.Now.Add(TimeSpan.FromMinutes(20)).ToUnixTimeSeconds() + ",\"client_liked\":true}";
        static readonly string order5 = "{\"number\":\"2343356552\",\"serial_number\":\"288380\",\"status\":1,\"start_city\":\"Петропавловская Борщаговка\",\"start_address\":\"ул. Садовая, 1В\",\"delivery_city\":\"Петропавловская Борщаговка\",\"delivery_address\":\"ул. Богдана Хмельницкого, 28\",\"distance\":5674,\"client_phone\":\"+380992373767\",\"comments\":\"Не трясти при перевозке. Заехать во двор через арку\",\"contents\":[{\"name\":\"Нагетсы\",\"count\":2,\"price\":50},{\"name\":\"Пицца\",\"count\":4,\"price\":80},{\"name\":\"Бургер 'DeLuxe\",\"count\":2,\"price\":120},{\"name\":\"Картошка 'По селянски'\",\"count\":4,\"price\":35}],\"amount\":835,\"type\":2,\"end_time\":" + DateTimeOffset.Now.Add(TimeSpan.FromMinutes(40)).ToUnixTimeSeconds() + ",\"client_liked\":false}";
        static readonly string order6 = "{\"number\":\"2343356553\",\"serial_number\":\"288381\",\"status\":1,\"start_city\":\"Петропавловская Борщаговка\",\"start_address\":\"ул. Садовая, 1В\",\"delivery_city\":\"Петропавловская Борщаговка\",\"delivery_address\":\"ул. Богдана Хмельницкого, 28\",\"distance\":5674,\"client_phone\":\"+380992373767\",\"comments\":\"Не трясти при перевозке. Заехать во двор через арку\",\"contents\":[{\"name\":\"Нагетсы\",\"count\":2,\"price\":50},{\"name\":\"Пицца\",\"count\":4,\"price\":80},{\"name\":\"Бургер 'DeLuxe\",\"count\":2,\"price\":120},{\"name\":\"Картошка 'По селянски'\",\"count\":4,\"price\":35}],\"amount\":835,\"type\":2,\"end_time\":" + DateTimeOffset.Now.Add(TimeSpan.FromMinutes(20)).ToUnixTimeSeconds() + ",\"client_liked\":true}";
